...
INSERT INTO usuarios (nome, email, senha, tipo, verificado) 
VALUES ('Administrador', 'admin@pratojusto.org', '$2a$10$YourHashedPasswordHere', 'INDIVIDUAL', TRUE);
📁 Estrutura do Projeto
text
Prato_Justo/
├── src/
│   ├── main/
│   │   ├── java/com/TCC/PratoJusto/
│   │   │   ├── PratoJustoApplication.java          # Classe principal
│   │   │   ├── config/                            # Configurações
│   │   │   │   ├── SecurityConfig.java            # Config. Spring Security
│   │   │   │   ├── WebConfig.java                 # Config. Web/CORS
│   │   │   │   ├── JpaConfig.java                 # Config. JPA
│   │   │   │   └── SwaggerConfig.java             # Config. Documentação API
│   │   │   │
│   │   │   ├── controller/                        # Controladores REST
│   │   │   │   ├── AuthController.java            # Autenticação
│   │   │   │   ├── UserController.java            # Usuários
│   │   │   │   ├── ItemController.java            # Itens para doação
│   │   │   │   ├── SolicitacaoController.java     # Solicitações
│   │   │   │   ├── ChatController.java            # Chat em tempo real
│   │   │   │   └── RelatorioController.java       # Relatórios
│   │   │   │
│   │   │   ├── service/                           # Lógica de negócio
│   │   │   │   ├── AuthService.java               # Serviço de autenticação
│   │   │   │   ├── UserService.java               # Serviço de usuários
│   │   │   │   ├── ItemService.java               # Serviço de itens
│   │   │   │   ├── GeolocationService.java        # Serviço de geolocalização
│   │   │   │   ├── NotificationService.java       # Serviço de notificações
...
│   │   │   ├── model/                             # Entidades JPA
│   │   │   │   ├── User.java                      # Usuário
│   │   │   │   ├── Item.java                      # Item para doação
│   │   │   │   ├── Solicitacao.java               # Solicitação
│   │   │   │   ├── ChatMessage.java               # Mensagem de chat
│   │   │   │   ├── Avaliacao.java                 # Avaliação
│   │   │   │   └── Endereco.java                  # Endereço
│   │   │   │
...
│   │   │   │   └── SecurityUtils.java             # Utilitários
│   │   │   │
...
│   │   │       └── GeolocationUtils.java          # Utilitários de geolocalização
│   │   │
│   │   └── resources/
...
│   └── migration.sh                               # Script de migração
│
